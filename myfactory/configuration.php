...
elseif(!empty($_GET['action']) and is_numeric($_GET['action'])) {
	...
	$rR = "UPDATE ".S_CONFIG." SET  NomSite = ?,TagLine = ?,MailDestinataire = ?,MailLorsPaiement = ?,GoogleAnalytics = ?,Regles = ?,HomeMetaTitle = ?,HomeMetaDescription = ?,HomeDescriptionH2 = ?,HomeDescription = ?,HomeSitesH2 = ?,HomeSitesAffiches = ?,SidebarCategorieH2 = ?,SidebarSitesH2 = ?,SidebarNavigationH2 = ?,CaracteresMinDescription1 = ?,CaracteresMaxDescription1 = ?,CaracteresMinDescription2 = ?,CaracteresMaxDescription2 = ?,PaypalPrix = ?,PaypalMonnaie = ?,PaypalMail = ? WHERE id = 1";
	$aArg = array($_POST['NomSite'],$_POST['TagLine'],$_POST['MailDestinataire'],$_POST['MailLorsPaiement'],$_POST['GoogleAnalytics'],$_POST['Regles'],$_POST['HomeMetaTitle'],$_POST['HomeMetaDescription'],$_POST['HomeDescriptionH2'],$_POST['HomeDescription'],$_POST['HomeSitesH2'],$_POST['HomeSitesAffiches'],$_POST['SidebarCategorieH2'],$_POST['SidebarSitesH2'],$_POST['SidebarNavigationH2'],$_POST['CaracteresMinDescription1'],$_POST['CaracteresMaxDescription1'],$_POST['CaracteresMinDescription2'],$_POST['CaracteresMaxDescription2'],$_POST['PaypalPrix'],$_POST['PaypalMonnaie'],$_POST['PaypalMail']);
	$oSql->Query($rR,$aArg);
