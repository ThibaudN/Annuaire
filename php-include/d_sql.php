...
define('DB_LOGIN', 'Annuaire');
define('DB_PASS', '****');
define('DB_BASE', 'Annuaire');
define('S_CONFIG','Annuaire_Config');
define('S_CATEGORIES','Annuaire_Categories');
define('S_FICHES','Annuaire_Fiches');
define('S_SIDEBAR','Annuaire_Sidebar');
define('S_ANTIROBOTS','Annuaire_AntiRobots');
define('S_PAYPAL','Annuaire_Paypal');


#TABLE SQL DE BASE
/*
CREATE TABLE `Annuaire_AntiRobots` (
  `id` smallint(5) UNSIGNED NOT NULL,
  `Question` varchar(250) NOT NULL,
  `Reponse` varchar(250) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
  
CREATE TABLE `Annuaire_Categories` (
  `id` smallint(5) UNSIGNED NOT NULL,
