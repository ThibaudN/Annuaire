...
CREATE TABLE `Prefix_Config` (
  ...
  `ThemeColor` varchar(250) NOT NULL,
  ...
  `FicheMetaTitle` VARCHAR(250) NOT NULL,
  `FicheMetaDescription` VARCHAR(250) NOT NULL,
  `PaiementDescription` TEXT NOT NULL,
  `PaypalPrix` varchar(9) NOT NULL,
  `PaypalMonnaie` varchar(5) NOT NULL,
  `PaypalMail` varchar(250) NOT NULL,
  `PaypalBoutonId` varchar(250) NOT NULL,
  `MentionsLegales` text NOT NULL,
  `isConfig` tinyint(1) UNSIGNED NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
ALTER TABLE `Prefix_Fiches` MODIFY `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT;
...
INSERT INTO `Prefix_Config` (`id`, `NomSite`, `TagLine`, `ThemeColor`, `MailDestinataire`, `MailLorsPaiement`, `HomeMetaTitle`, `HomeMetaDescription`, `HomeDescriptionH2`, `HomeDescription`, `HomeSitesH2`, `HomeSitesAffiches`, `SidebarCategorieH2`, `SidebarSitesH2`, `SidebarNavigationH2`, `GoogleAnalytics`, `Regles`, `CaracteresMinDescription1`, `CaracteresMaxDescription1`, `CaracteresMinDescription2`, `CaracteresMaxDescription2`, `FicheMetaTitle`, `FicheMetaDescription`, `PaiementDescription`, `PaypalPrix`, `PaypalMonnaie`, `PaypalMail`,`PaypalBoutonId`,`MentionsLegales`,`isConfig`) VALUES (1, 'Annuaire', 'Un annuaire de référence pour un réferencement de référence', 'green', '', 1, 'Annuaire', 'Un annuaire qui te fera naviguer sur inter', 'H2 Description Home', 'Description sur la home', 'Les derniers sites référencés', 20, 'L\'annuaire', 'A voir', 'Navigation', '', '<ol>\r\n<li>Le titre et la description doivent être écrit en français</li>\r\n<li>Son contenu doit être de qualité.</li>\r\n<li>Pas plus d\'une pop-up en page d\'accueil</li>\r\n<li>Pas de blogs miroirs (un même contenu pour plusieurs urls)</li>\r\n<li>Pas de sites internet en construction</li>\r\n<li>Le site web doit avoir son propre nom de domaine</li>\r\n<li>Pas de titre ni de description en majuscules</li>\r\n<li>Pas de site au contenu illicite et/ou interdit.</li>\r\n<li>Pas de description et de titre au style commercial ou une suite de mots clefs</li>\r\n</ol>', 300, 350, 1500, 3000, 'Présentation du site ::NOMSITE', 'Nous vous présentons le site internet ::NOMSITE référencé dans la catégorie ::NOMCATEGORIE', '<p>Vous ne payez pas le lien mais le temps que nous allons passer à la modération de votre fiche.</p><p>Le fait de payer NE GARANTIT PAS par que votre site sera accepté. Si le contenu est dupliqué ou que votre site ne respecte pas les règles, nous n\'auront aucun scrupule à le refuser.</p><p>Le coût pour la modération est de ::PRIX.</p><p>Vous recevez un email pour vous signaler le résultat de la modération qui est réalisée en moins de 24 heures.</p>', '5.00', 'EUR', '', '', '<div class="text-center"><img src="http://placehold.it/500x350" alt="" class="" /></div>',0);
